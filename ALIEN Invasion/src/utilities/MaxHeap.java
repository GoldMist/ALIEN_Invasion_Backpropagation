...
/**
 * A max heap.  For the PriorityQueue implementation.  For our purpose, we do
...
public class MaxHeap<T extends Comparable<? super T>> {
     ...
     */
    public MaxHeap(int theCapacity) {
    ...
    public void insert(T item) {
        ...
        while (currIndex > 1) {
            ...
            // if the item is bigger than its parent, bubble it up
    ...
    public T deletemax() {
        ...
        // replace maxItem with last item
